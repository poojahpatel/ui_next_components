...
const SvgTiPhoneOutgoingOutlined = (props: SvgIconProps) => {
  ...
  return (
    <SvgIcon
      ...
      {...other}
    >
      <g clipPath="url(#clip0_12170_56873)">
        <path
          strokeLinecap="round"
...
const ForwardRef = forwardRef(SvgTiPhoneOutgoingOutlined);
