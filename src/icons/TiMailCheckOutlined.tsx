...
const SvgTiMailCheckOutlined = (props: SvgIconProps) => {
  ...
  return (
    <SvgIcon
      ...
      {...other}
    >
      <g clipPath="url(#clip0_6778_15284)">
        <path
          strokeLinecap="round"
        ...
        <path
          ...
          fill="none"
          stroke="currentColor"
          d="M15.7998 17.75L17 19L19.2998 16.25"
        />
      </g>
      <defs>
        <clipPath id="clip0_6778_15284">
...
const ForwardRef = forwardRef(SvgTiMailCheckOutlined);
